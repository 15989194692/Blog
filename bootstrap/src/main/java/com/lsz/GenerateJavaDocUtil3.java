...
public class GenerateJavaDocUtil3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            cu.findAll(ClassOrInterfaceDeclaration.class).forEach(cls -> {
                ...
                cls.findAll(MethodDeclaration.class).forEach(method -> {
                    ...
                    if (!isPrimitive(returnType.asString())) {
                        sb.append("| Returns | ").append(returnType.asString()).append(" | |\n");
            ...
            // 将提取的内容写入Markdown文档
            try (FileWriter writer = new FileWriter("SampleApi_API_Documentation3.md")) {
